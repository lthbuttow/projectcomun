    ...
    <article class="mastheads article text-center text-white d-flex">
      <div class="container my-auto">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-2 mt-2">
            <a class="btn btn-md btn-outline-success" style="width: 180px;" href="edit_user.php" role="button">ENVIAR ARQUIVOS</a>
          </div>
          <div class="col-md-2 mt-2">
            ...
            <div class="col-md-6">
              <form method="POST">
                <div class="form-group">
                  ...
                  <input type="file" name="nome" class="form-control" id="nome" aria-describedby="emailHelp" placeholder="Digite o nome do usuário...">
                </div>              
                <div class="form-group">
                  <label for="email">E-mail </label>
                  <input type="email" name="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Digite o E-mail">
